...
const int NOTE_OFF = 5;
    ...
    //Caxixi Left
#define OCTAVE_DOWN_BUTTON_PIN 5 // OCTAVE 
#define SAMPLER_BUTTON_CLEAR_PIN 6 //Sampler

    //Caxixi Right
#define OCTAVE_UP_BUTTON_PIN 4 // OCTAVE
#define SAMPLER_BUTTON_RECORD_PIN 3 //Sampler


    //Caxixi Receiver 
//LEDS
#define OCTAVE_DOWN_LED_GREEN_PIN 3
#define OCTAVE_DOWN_LED_RED_PIN 4
#define OCTAVE_UP_LED_GREEN_PIN 5
#define OCTAVE_UP_LED_RED_PIN 6
