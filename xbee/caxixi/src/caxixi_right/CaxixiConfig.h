...
// OCTAVE
#define OCTAVE_DOWN_BUTTON_PIN 4 
#define OCTAVE_UP_BUTTON_PIN 6
#define OCTAVE_UP_LED_RED_PIN 10
#define OCTAVE_UP_LED_GREEN_PIN 11
#define OCTAVE_DOWN_LED_RED_PIN 8
#define OCTAVE_DOWN_LED_GREEN_PIN 9

// SAMPLER
#define RECORD_LED_PIN 12
#define SAMPLER_BUTTON_RECORD_PIN 5
#define SAMPLER_BUTTON_CLEAR_PIN 3
