...
const String CAXIXI_RIGHT_FORWARD_NOTEON = "A";
const String CAXIXI_RIGHT_FORWARD_NOTEOFF = "B";
const String CAXIXI_RIGHT_BACKWARD_NOTEON = "C";
const String CAXIXI_RIGHT_BACKWARD_NOTEOFF = "D";
const String CAXIXI_RIGHT_HIT_NOTEON = "E";
const String CAXIXI_RIGHT_HIT_NOTEOFF = "F";
const String CAXIXI_LEFT_FORWARD_NOTEON = "G";
const String CAXIXI_LEFT_FORWARD_NOTEOFF = "H";
const String CAXIXI_LEFT_BACKWARD_NOTEON = "I";
const String CAXIXI_LEFT_BACKWARD_NOTEOFF = "J";
const String CAXIXI_LEFT_HIT_NOTEON = "K";
const String CAXIXI_LEFT_HIT_NOTEOFF = "L";